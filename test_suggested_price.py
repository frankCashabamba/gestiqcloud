...
Nota: Este archivo es un script manual y no forma parte del suite de pytest.
Si pytest lo recoge por error, se omite con un skip a nivel de módulo.
"""

import os
if __name__ != "__main__":
    import pytest  # type: ignore
    pytest.skip("Script manual, se omite en pytest", allow_module_level=True)
