...
| 8 | Router moderno fuente de verdad | 🟡 **Inventariado** (2026-06-10): `docs/routes-inventory.md` (830 rutas, **0 colisiones**, 44 endpoints de doble superficie). `build_api_router` confirmado como fuente de verdad (el frontend usa `/api/v1/tenant/...`). Falta: retirar los montajes legacy de `main.py` módulo a módulo validando que no se usan. |
