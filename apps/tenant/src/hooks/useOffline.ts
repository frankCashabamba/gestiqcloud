  ...
  useEffect(() => {
    const updateCounts = async () => {
      try {
        ...
        const entities: EntityType[] = ['product', 'customer', 'sale', 'receipt', 'purchase', 'shift', 'invoice', 'expense', 'inventory', 'supplier', 'lead', 'hr', 'production', 'order', 'account', 'cashflow', 'setting', 'notification']
