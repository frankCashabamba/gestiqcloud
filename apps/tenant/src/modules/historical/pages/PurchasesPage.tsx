...
import { listPurchases, type HistPurchase, type PaginatedResponse } from '../services'
import PageContainer from '../../../components/PageContainer'

const EMPTY: PaginatedResponse<HistPurchase> = { items: [], total: 0, page: 1, page_size: 50 }
...
export default function PurchasesPage() {
  ...
  return (
    <PageContainer>
      <h1 style={{ margin: '0 0 1rem', fontSize: 24, color: '#0f172a' }}>Compras históricas</h1>
