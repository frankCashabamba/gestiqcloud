...
import { createProveedor } from './services'
      ...
      <form onSubmit={handleSubmit} className="rounded-xl border bg-white p-6 shadow-sm">
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <button type="button" onClick={() => navigate('/proveedores')} className="rounded-lg border px-6 py-3 font-medium hover:bg-slate-50">
              Cancelar
            </button>
          </div>
        </div>
