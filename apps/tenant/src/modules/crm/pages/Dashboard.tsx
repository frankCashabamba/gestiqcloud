...
export default function CRMDashboard() {
  ...
  if (loading) return <div className="p-4 text-gray-500">{tCommon('loading')}</div>

  if (!metrics) return <div className="p-4">{t('noData')}</div>
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-4 rounded-lg shadow border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t('dashboard.totalLeads')}</p>
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t('dashboard.opportunities')}</p>
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">{t('dashboard.pipelineValue')}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-4 rounded-lg shadow border">
          <h3 className="font-semibold mb-4">{t('dashboard.leadsByStatus')}</h3>
        ...
        <div className="bg-white p-4 rounded-lg shadow border">
          <h3 className="font-semibold mb-4">{t('dashboard.opportunitiesByStage')}</h3>
          <div className="space-y-2">
        ...
        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
          <p className="text-sm text-green-700">{t('dashboard.won')}</p>
          <p className="text-2xl font-bold text-green-800">{wonOpportunities}</p>
        </div>

        <div className="bg-red-50 p-4 rounded-lg border border-red-200">
          <p className="text-sm text-red-700">{t('dashboard.lost')}</p>
