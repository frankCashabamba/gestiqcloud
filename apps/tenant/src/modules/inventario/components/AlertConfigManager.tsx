...
export default function AlertConfigManager() {
  ...
  const loadConfigs = async () => {
    try {
      ...
      alert('Error al cargar configuraciones de alertas')
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleTest = async (configId: string) => {
    try {
      ...
      alert(`Prueba enviada. Canales: ${result.channels_sent.join(', ')}`)
    } catch (error) {
  ...
  const handleCheckAlerts = async () => {
    try {
      ...
      alert(`${result.alerts_sent} alertas enviadas`)
    } catch (error) {
          ...
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full m-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Tipo de Umbral</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Valor del Umbral</label>
                  <input
                    type="number"
                    step="0.01"
              ...
              <div className="border-t pt-4">
                <h4 className="font-semibold mb-3">Canales de Notificación</h4>
                ...
                <div className="mb-4">
                  ...
                  {formData.notify_telegram && (
                    <textarea
                      placeholder="IDs de chat separados por coma"
      ...
      <div className="space-y-4">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  Frecuencia: {config.check_frequency_minutes}min
                </p>
        ...
        {configs.length === 0 && (
          <div className="text-center py-8 text-gray-500">
            No hay configuraciones de alertas. Crea una para comenzar.
          </div>
        )}
      </div>
    </div>
