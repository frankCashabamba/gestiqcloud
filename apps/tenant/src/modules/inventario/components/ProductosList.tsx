  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <div className="text-sm text-gray-600">Mostrando {filtered.length} de {base.length} productos</div>
      </div>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  {editingId === p.id ? (
                    <div className="flex gap-2">
                      <button onClick={() => saveEdit(p.id)} className="px-3 py-1 bg-green-600 text-white rounded hover:bg-green-700">Guardar</button>
                      <button onClick={cancelEdit} className="px-3 py-1 bg-gray-400 text-white rounded hover:bg-gray-500">Cancelar</button>
                    </div>
                  ) : (
                    <button onClick={() => startEdit(p)} className="px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700">Editar</button>
                  )}
                </td>
              </tr>
            ))}
