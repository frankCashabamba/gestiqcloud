        ...
        result.update(
            {
                ...
                "cost_price": product.get("cost_price") or product.get("cost") or product.get("unit_cost"),
                "cost": product.get("cost") or product.get("cost_price") or product.get("unit_cost"),
                "unit_cost": product.get("unit_cost") or product.get("cost_price") or product.get("cost"),
