...
class FieldFeedback:
    ...
    user_corrected_to: str | None = None  # If user changed it
...
class MappingFeedback:
    ...
    def mark_field_corrected(
        self, source_field: str, our_suggestion: str, user_choice: str, confidence: float = 0.5
    ):
