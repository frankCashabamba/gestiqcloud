...
class OpenAIProvider(AIProvider):
    ...
    def __init__(self, api_key: str, model: str = "gpt-3.5-turbo"):
        ...
        self.cache = ClassificationCache(
            ttl_seconds=settings.IMPORT_AI_CACHE_TTL
        ) if settings.IMPORT_AI_CACHE_ENABLED else None
        ...
        try:
            ...
            response = self.openai.ChatCompletion.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a document classification expert."
                    },
                    {
                        "role": "user",
                        "content": prompt
            ...
            for p in available_parsers:
                if p == suggested:
                    ...
                    probabilities[p] = round((1.0 - confidence) / max(len(available_parsers) - 1, 1), 3)
