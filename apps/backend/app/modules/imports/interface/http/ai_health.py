...
async def ai_health(
    ...
    try:
        ...
        selected_provider = AIProviderFactory.get_provider(provider) if provider else None
        active_provider = selected_provider or await AIProviderFactory.get_available_provider(None)
