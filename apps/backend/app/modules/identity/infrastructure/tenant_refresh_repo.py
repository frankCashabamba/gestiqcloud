...
from app.core.refresh import _utcnow as _utcnow
from app.modules.identity.application.ports import RefreshTokenRepo


class TenantSqlRefreshTokenRepo(RefreshTokenRepo):
    """Refresh token storage for tenant (CompanyUser) identities."""
