...
from app.modules.webhooks.domain.models import WebhookSubscription, WebhookDelivery, EventType
from app.modules.webhooks.domain.events import WebhookEvent
from app.modules.webhooks.domain.exceptions import WebhookNotFound, InvalidWebhookURL, WebhookDisabled
...
class UpdateWebhookSubscriptionUseCase:
    ...
    def execute(
        ...
        *,
        ...
        subscription = db_session.query(WebhookSubscription).filter(
...
class GetWebhookDeliveryHistoryUseCase:
    ...
    def execute(
        ...
        *,
        ...
        query = db_session.query(WebhookDelivery).filter(
...
class RetryFailedDeliveryUseCase:
    ...
    def execute(
        ...
        *,
        ...
        delivery = db_session.query(WebhookDelivery).join(
            WebhookSubscription
        ).filter(
