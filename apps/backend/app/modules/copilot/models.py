...
class CopilotConversation(Base):
    ...
    messages = relationship("CopilotMessage", back_populates="conversation", order_by="CopilotMessage.created_at")

    __table_args__ = (
        Index("ix_copilot_conv_tenant_user", "tenant_id", "user_id"),
    )
