...
def test_tax_engine_totals_multiple_rates():
    lines = [
        LineInput(qty=Decimal("2"), unit_price=Decimal("10"), discount=Decimal("0"), tax_rate=Decimal("0.12")),
        LineInput(qty=Decimal("1"), unit_price=Decimal("5"), discount=Decimal("1"), tax_rate=Decimal("0")),
        LineInput(qty=Decimal("3"), unit_price=Decimal("2"), discount=Decimal("0"), tax_rate=Decimal("12")),
    ]
