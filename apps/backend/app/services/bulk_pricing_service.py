...
class BulkPricingService:
    ...
    def get_bulk_config_for_product(
        product_id: str,
        bulk_pricing_items: Optional[list],
    ) -> Optional[dict]:
    ...
    @staticmethod
    def validate_bulk_config(bulk_config: Optional[dict]) -> tuple[bool, Optional[str]]:
    ...
    @staticmethod
    def format_bulk_pricing_display(bulk_config: Optional[dict]) -> str:
