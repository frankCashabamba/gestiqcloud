"""
Milk Record Model - Registro de leche
"""
import uuid
...
class MilkRecord(Base):
    ...
    litros: Mapped[Decimal] = mapped_column(Numeric(14, 3), nullable=False)
    grasa_pct: Mapped[Optional[Decimal]] = mapped_column(Numeric(5, 2), nullable=True)
    ...
    def __repr__(self):
        return f"<MilkRecord {self.fecha} - {self.litros}L>"
