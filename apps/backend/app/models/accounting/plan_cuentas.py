...
from sqlalchemy import String, Numeric, ForeignKey, Integer, Date, Text, Enum as SQLEnum, TIMESTAMP, Boolean
...
class PlanCuentas(Base):
    ...
    codigo: Mapped[str] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="Código de la cuenta (ej: 5700001)"
    )
    ...
    saldo_debe: Mapped[Decimal] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Saldo acumulado debe"
    )
    saldo_haber: Mapped[Decimal] = mapped_column(
        Numeric(14, 2),
        nullable=False,
        default=0,
        comment="Saldo acumulado haber"
    )
    saldo: Mapped[Decimal] = mapped_column(
        Numeric(14, 2),
        nullable=False,
        default=0,
        comment="Saldo neto (debe - haber)"
    )
...
class AsientoContable(Base):
    ...
    numero: Mapped[str] = mapped_column(
        ...
        unique=True,
        index=True,
        comment="Número único (ASI-YYYY-NNNN)"
    )
    ...
    debe_total: Mapped[Decimal] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Suma total del debe"
    )
    haber_total: Mapped[Decimal] = mapped_column(
        Numeric(14, 2),
        nullable=False,
        default=0,
        comment="Suma total del haber"
    )
    cuadrado: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        default=False,
        comment="True si debe = haber"
    )
    ...
    ref_doc_type: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        comment="Tipo de documento origen (invoice, payment, etc.)"
    )
    ...
    contabilizado_by: Mapped[Optional[uuid.UUID]] = mapped_column(
        PGUUID(as_uuid=True),
        nullable=True
    )
    contabilizado_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True),
        nullable=True
    )
    created_at: Mapped[datetime] = mapped_column(
...
class AsientoLinea(Base):
    ...
    debe: Mapped[Decimal] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Importe al debe"
    )
    haber: Mapped[Decimal] = mapped_column(
        Numeric(14, 2),
        nullable=False,
        default=0,
        comment="Importe al haber"
    )
    ...
    orden: Mapped[int] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Orden dentro del asiento"
    )
