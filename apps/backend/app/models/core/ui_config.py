...
class UiSection(Base):
    ...
    module_requirement: Mapped[str | None] = mapped_column(
        String(100)
    )  # módulo que debe estar activo
...
class UiFilter(Base):
    ...
    )  # text, select, date, range, boolean
