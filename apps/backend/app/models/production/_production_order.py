...
from sqlalchemy import String, ForeignKey, Text, TIMESTAMP, Numeric, Integer, Enum as SQLEnum
...
class ProductionOrder(Base):
    ...
    product_id: Mapped[uuid.UUID] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="Producto final"
    )
    warehouse_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        PGUUID(as_uuid=True),
        nullable=True,
        comment="Almacén donde se produce"
    )
    ...
    qty_produced: Mapped[Decimal] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Cantidad real producida"
    )
    waste_qty: Mapped[Decimal] = mapped_column(
        Numeric(14, 3),
        nullable=False,
        default=0,
        comment="Cantidad de mermas/desperdicios"
    )
    waste_reason: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Motivo de las mermas"
    )
    ...
    scheduled_date: Mapped[Optional[datetime]] = mapped_column(
        ...
        nullable=True,
        comment="Fecha programada de producción"
    )
    started_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True),
        nullable=True,
        comment="Fecha/hora de inicio real"
    )
    completed_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True),
        nullable=True,
        comment="Fecha/hora de finalización real"
    )
    ...
    batch_number: Mapped[Optional[str]] = mapped_column(
        ...
        nullable=True,
        index=True,
        comment="Número de lote generado (ej: LOT-2025-001)"
    )
    ...
    notes: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
        comment="Notas internas de producción"
    )
...
class ProductionOrderLine(Base):
    ...
    ingredient_product_id: Mapped[uuid.UUID] = mapped_column(
        ...
        nullable=False,
        index=True,
        comment="Producto ingrediente"
    )
    stock_move_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        PGUUID(as_uuid=True),
        nullable=True,
        comment="Movimiento de stock generado"
    )
    ...
    qty_required: Mapped[Decimal] = mapped_column(
        Numeric(14, 3),
        nullable=False,
        comment="Cantidad requerida según receta"
    )
    qty_consumed: Mapped[Decimal] = mapped_column(
        Numeric(14, 3),
        nullable=False,
        default=0,
        comment="Cantidad real consumida"
    )
    ...
    cost_total: Mapped[Decimal] = mapped_column(
        ...
        nullable=False,
        default=0,
        comment="Costo total de la línea"
    )
