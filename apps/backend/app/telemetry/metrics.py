...
def _ensure_metrics():
    ...
    try:
        ...
        _ACTIVE_REQUESTS = pc.Gauge("http_requests_active", "Active HTTP requests", ["method"])
        _DB_QUERY_COUNT = pc.Counter("db_queries_total", "Total database queries", ["operation"])
