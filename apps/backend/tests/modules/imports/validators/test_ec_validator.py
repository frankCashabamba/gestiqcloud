...
class TestECValidator:
    ...
    def test_validate_clave_acceso_empty(self):
        errors = self.validator.validate_clave_acceso("")
        assert len(errors) == 1
        assert errors[0]["code"] == "EMPTY_VALUE"
