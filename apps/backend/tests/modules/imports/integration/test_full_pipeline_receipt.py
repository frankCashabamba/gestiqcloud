...
def test_tenant_es(db_session: Session) -> dict:
    ...
    db_session.commit()
    return {"tenant_id": tenant_id, "empresa_id": 2, "country": "ES"}
...
def test_full_pipeline_receipt_ocr(db_session: Session, test_tenant_es: dict, recibo_gasolina_jpg: Path):
    """
    ...
    empresa_id = test_tenant_es["empresa_id"]
