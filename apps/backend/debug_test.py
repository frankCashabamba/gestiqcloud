...
def test_debug():
    ...
    from app.tests.conftest import _ensure_test_env, _recreate_sqlite_db_if_needed, _load_all_models, _prune_pg_only_tables, _ensure_sqlite_stub_tables, _ensure_default_tenant
    import importlib
    import os
    import uuid
    ...
    print(f"Created user: {usuario.id}, tenant: {tenant.id}, activo: {usuario.activo}, is_active: {usuario.is_active}")
