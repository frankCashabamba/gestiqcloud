-- =============================================================================
-- RLS Admin Bypass — idempotente
--
-- Crea la función is_app_admin() y agrega la política "admin_bypass" a TODAS
-- las tablas con RLS activo en el schema public.
--
-- Los superadmins setean app.bypass_rls = 'true' vía get_db() automáticamente,
...
--    Itera sobre pg_class para encontrarlas y aplica la política.
