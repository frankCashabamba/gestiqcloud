...
ADD COLUMN suggested_parser VARCHAR(255),
...
CREATE INDEX idx_import_batches_ai_provider ON import_batches(ai_provider);
CREATE INDEX idx_import_batches_ai_enhanced ON import_batches(ai_enhanced);
