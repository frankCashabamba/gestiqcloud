...
ALTER TABLE recipes
ADD COLUMN IF NOT EXISTS costo_por_unidad NUMERIC(12,4)
GENERATED ALWAYS AS (
  CASE
...
ADD COLUMN IF NOT EXISTS costo_ingrediente NUMERIC(12,4)
GENERATED ALWAYS AS (
  CASE
...
CREATE INDEX IF NOT EXISTS idx_recipes_costo_por_unidad ON recipes(costo_por_unidad);
